...
- *Outreach-page* -: Images for gallery are stored in public/outreach-images. The images are also present in github repo - virtual-labs/outreach-web-pages-iiith/photographs.
    **Future Work** - Fetch images from github at build time. So everytime a new image is added, the website has to be built again.
    ...
    **Future work** - Fetch content from github at build time itself. So everytime a new image is added, the website has to be built again.
    
    To add any tab to the page, changes have to be made to the code.
    **Future work** - List of tabs should be a json file. A new tab to be added can be added through the json file directly.

    **Future Work** - Images should enlarge upon clicking.
